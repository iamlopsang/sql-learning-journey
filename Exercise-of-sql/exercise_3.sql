...
-- Explanation: This query displays the maximum age among employees in the IT department by filtering the
-- records where the Department is 'IT' and finding the highest age.
...
-- Explanation: This query displays the minimum salary among employees who are older than 40 by filtering 
